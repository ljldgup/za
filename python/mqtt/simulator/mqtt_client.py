...
def on_connect(client: mqtt.Client, userdata, flags, rc):
    ...
    publish_service_data_upload_message(client, client_id, client_id)
    publish_service_event_upload_message(client,client_id,client_id)
    publish_device_file_upload(client,client_id,client_id)
...
if __name__ == '__main__':
    ...
    username = "1564864858657689600&1663725858465"
